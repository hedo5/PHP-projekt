<?php 
	...
	if (isset($_GET['delete']) && $_GET['delete'] != '') {
		...
		$_SESSION['message'] = '<p>Usješno ste obrisali profil korisnika</p>';
	...
	if (isset($_GET['id']) && $_GET['id'] != '') {
		...
		print '
		<h2>Promjena korisničkih podataka</h2>
		...
		<div id="users">
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					print '
					<tr>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;id=' .$row['id']. '"><img src="" alt="Korisnik"></a></td>
